...
nome.addEventListener("keyup", () => {
  if (nome.value.length <= 4) {
    ...
    labelNome.innerHTML =
      "<strong>Nome *Insira no minimo 5 caracteres</strong>";
...
text.addEventListener("keyup", () => {
  if (text.value.length == null) {
    labelText.setAttribute("style", "color: red");
    labelText.innerHTML =
      "<strong>Mensagem *Preencha o campo corretamente</strong>";
    valiTelefone = false;
  } else {
    labelText.setAttribute("style", "color: green");
    labelText.innerHTML = "<strong>Mensagem</strong>";
    valiTelefone = true;
  }
});
